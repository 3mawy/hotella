            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg">
                        <a class="navbar-brand" href="index.html"><img src="{{asset('frontend')}}/img/core-img/logo.png" alt=""></a>
                ...
                <div class="col-12">
                    <div class="features-slides owl-carousel">
                        ...
                        <div class="single-features-area">
                            <img src="{{asset('frontend')}}/img/bg-img/feature-1.jpg" alt="">
                            <!-- Price -->
                        ...
                        <!-- Single Features Area -->
                        <div class="single-features-area">
                            <img src="{{asset('frontend')}}/img/bg-img/feature-2.jpg" alt="">
                            <!-- Price -->
                            <div class="price-start">
                                <p>FROM $59/night</p>
                            </div>
                        ...
                        <!-- Single Features Area -->
                        <div class="single-features-area">
                            <img src="{{asset('frontend')}}/img/bg-img/feature-3.jpg" alt="">
                            <!-- Price -->
                            <div class="price-start">
                                <p>FROM $59/night</p>
                            </div>
                        ...
                        <!-- Single Features Area -->
                        <div class="single-features-area">
                            <img src="{{asset('frontend')}}/img/bg-img/feature-4.jpg" alt="">
                            <!-- Price -->
                            <div class="price-start">
                                <p>FROM $59/night</p>
                            </div>
                        ...
                        <!-- Single Features Area -->
                        <div class="single-features-area">
                            <img src="{{asset('frontend')}}/img/bg-img/feature-5.jpg" alt="">
                            <!-- Price -->
                            <div class="price-start">
                                <p>FROM $59/night</p>
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="features-slides owl-carousel">
                        <!-- Single Features Area -->
                        <div class="single-features-area">
                            <img src="{{asset('frontend')}}/img/bg-img/feature-6.jpg" alt="">
                            <!-- Rating & Map Area -->
                        ...
                        <!-- Single Features Area -->
                        <div class="single-features-area">
                            <img src="{{asset('frontend')}}/img/bg-img/feature-7.jpg" alt="">
                            <!-- Rating & Map Area -->
                            <div class="ratings-map-area d-flex">
                                <a href="#">9.5</a>
                                <a href="#"><img src="{{asset('frontend')}}/img/core-img/map.png" alt=""></a>
                        ...
                        <!-- Single Features Area -->
                        <div class="single-features-area">
                            <img src="{{asset('frontend')}}/img/bg-img/feature-8.jpg" alt="">
                            <!-- Rating & Map Area -->
                            <div class="ratings-map-area d-flex">
                                <a href="#">8.2</a>
                                <a href="#"><img src="{{asset('frontend')}}/img/core-img/map.png" alt=""></a>
                        ...
                        <!-- Single Features Area -->
                        <div class="single-features-area">
                            <img src="{{asset('frontend')}}/img/bg-img/feature-9.jpg" alt="">
                            <!-- Rating & Map Area -->
                            <div class="ratings-map-area d-flex">
                                <a href="#">8.7</a>
                                <a href="#"><img src="{{asset('frontend')}}/img/core-img/map.png" alt=""></a>
                        ...
                        <!-- Single Features Area -->
                        <div class="single-features-area">
                            <img src="{{asset('frontend')}}/img/bg-img/feature-10.jpg" alt="">
                            <!-- Rating & Map Area -->
                            <div class="ratings-map-area d-flex">
                                <a href="#">9.8</a>
                                <a href="#"><img src="{{asset('frontend')}}/img/core-img/map.png" alt=""></a>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-feature-events-area d-sm-flex align-items-center wow fadeInUpBig" data-wow-delay="0.6s">
                        <div class="feature-events-thumb">
                            <img src="{{asset('frontend')}}/img/bg-img/event-5.jpg" alt="">
                            <div class="date-map-area d-flex">
                                <a href="#">26 Nov</a>
                                <a href="#"><img src="{{asset('frontend')}}/img/core-img/map.png" alt=""></a>
                            </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-feature-events-area d-sm-flex align-items-center wow fadeInUpBig" data-wow-delay="0.7s">
                        <div class="feature-events-thumb">
                            <img src="{{asset('frontend')}}/img/bg-img/event-6.jpg" alt="">
                            <div class="date-map-area d-flex">
                                <a href="#">26 Nov</a>
                                <a href="#"><img src="{{asset('frontend')}}/img/core-img/map.png" alt=""></a>
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="clients-logo d-md-flex align-items-center justify-content-around">
                        <img src="{{asset('frontend')}}/img/clients-img/1.png" alt="">
                        <img src="{{asset('frontend')}}/img/clients-img/2.png" alt="">
                        <img src="{{asset('frontend')}}/img/clients-img/3.png" alt="">
                        <img src="{{asset('frontend')}}/img/clients-img/4.png" alt="">
                        <img src="{{asset('frontend')}}/img/clients-img/5.png" alt="">
                    </div>
                </div>
            </div>
        </div>
